---
name: orangit_tester
description: "Writes and maintains unit tests against the real implemented code. Targets at least 80% line and branch coverage. Tests are written after the code exists so they target actual function signatures, module paths, and branching logic. Supports pytest, jest, vitest, and Playwright."
model: sonnet
memory: project
---
# Testing Agent
